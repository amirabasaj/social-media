   ...
   <div class="loginRegister-container">
     <div class="loginRegister-container-box">
       ...
       <div class="loginRegister-container-box_loginForm">
         ...
         <a class="loginRegister-container-box_loginForm_forgotPasswordLink">فراموشی رمز</a>
       </div>

       <div class="loginRegister-container-box_forgotPasswordForm">
         <form action="forgot_password.php" method="POST">
           <div class="loginRegister-container-box_forgotPasswordForm_errorBox">
             <p>اروری وجود ندارد</p>
           </div>
           <input type="email" required required placeholder="ایمیل" name="email_address">
           <input type="submit" value="ارسال ایمیل" name="sendemail">
         </form>
         <a class="loginRegister-container-box_forgotPasswordForm_loginLink">اکانت دارید؟وارد شوید</a>
       </div>
       ...
       <div class="loginRegister-container-box_registerForm">
         <form action="register_handler.php" method="POST">
           ...
           <input type="text" placeholder="نام کاربری" name="reg_username" value="<?php
																																									if (isset($_SESSION['reg_username'])) echo $_SESSION['reg_username']; ?>"
             required>
