...
<body>
  ...
  <section class="profile">
    ...
    <div class="profile-tab show" id="change-info">
      ...
      <?php
				if (isset($_SESSION['user_profile']['change_pass']))	echo $_SESSION['user_profile']['change_pass'];

			?>
      <form class="change-info-form"
        action="./controllers/change_password.php?userid=<?php echo $_SESSION['login_username'] ?>" method="POST">
        <div>
          <label for="old-password">رمز عبور قبلی</label>
          <input placeholder="رمز عبور قبلی را وارد کنید" type="password" name="old-password"
            class="primary-input mt-2 mb-2">

          <label for="new-password">رمز عبور جدید</label>
          <input placeholder="رمز عبور جدید را وارد کنید" type="password" name="new-password"
            class="primary-input mt-2 mb-2">
        </div>
      ...
      <?php
				...
				?>
      <form class="change-image-form" action="./controllers/photo_change.php" method="POST"
          ...
          <div class="see-statistics-box-item_header">
            <?php
								switch (separator($post_media)) {
									case 0:
								?>
            <a href="post_single.php?id=<?php echo $post_id ?>"><img src="./images/<?php echo $post_media ?>"
                class="container-main-posts-item_header_img"></a>

            <?php
										break;
									case 1:
									?>
            <a href="post_single.php?id=<?php echo $post_id ?>"><video class="video-js" controls preload="auto"
                poster="../assets/img/login_register-background.jpg" data-setup="{}"></a>
    ...
    <div class="profile-tab" id="add-post">
      ...
      <div class="add-post-box">
        <?php
					...
					?>
        <form class="add-post-box-form" method="post" action="controllers/add_post.php" enctype="multipart/form-data">
    ...
    <form action="controllers/unfollow.php" method="POST">
      <div class="change-info-form-submit">
    ...
    <?php } else {
				...
				?>
    <form action="controllers/follow_req.php" class="request-box" method="POST">
    ...
    <form action="controllers/unfollow.php" class="request-box" method="POST">
          ...
          <div class="another-user-posts-box-item">
            <div class="another-user-posts-box-item_header">
              <?php
										...
										?>
              <a href="post_single.php?id=<?php echo $post_id ?>"><img src="./images/<?php echo $post_media ?>"
                  class="another-user-posts-box-item_header_img"></a>
